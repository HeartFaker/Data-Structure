...
#define VECTOR_DEFAULT_SIZE 100 //容量大小
...
/***************************************************************************
  函数名称：insertVertex(const int& vertex)
  功    能：插入顶点
  输入参数：
  返 回 值：
  说    明：
...
/***************************************************************************
  函数名称：insertEdge(int v1, int v2, int weight)
  功    能：插入边
  输入参数：
  返 回 值：
  说    明：
